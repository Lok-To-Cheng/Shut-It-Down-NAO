...
# Background Image
lvl0ImgSrc = pygame.image.load("Images/Level/0/background.png")
...
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.y_vel += gravity
        if self.rect.y < scrH - lvl0floorH: self.rect.y += self.y_vel
        else: self.kill()
